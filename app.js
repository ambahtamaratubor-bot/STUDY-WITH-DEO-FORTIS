...
toolbar.append(btn(btnConfig.label,'btn-outline',handler,{style:{fontSize:'11px',padding:'4px 10px',fontWeight:btnConfig.fontWeight,fontStyle:btnConfig.fontStyle}}));});
return toolbar;}
